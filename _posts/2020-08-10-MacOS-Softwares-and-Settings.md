...
- [装机必备](#装机必备)
  ...
  - [iShot](#ishot)
  - [Auto Switch Input](#auto-switch-input)
  - [uPic](#upic)
  - [Keka](#keka)
  - [iPreview](#ipreview)
  - [Flux](#flux)
...
- [效率利器](#效率利器)
  ...
  - [Mounty](#mounty)
  - [Texpad](#texpad)
  - [Matrix Snipping Tool](#matrix-snipping-tool)
  - [Detexify](#detexify)
  - [Money Pro](#money-pro)
  - [Downie 4](#downie-4)
...
- 推荐指数：★★★★☆
- 费用：免费
- 推荐理由：软件包含功能全面的录屏，窗口截图，长截图，快速标注等多种功能。完全可以代替系统自带的截图软件。重点是它支持悬浮在最上面，方便对比多个图片，效率利器。

![ishot_1.png](https://i.loli.net/2020/08/14/eOdQc847FrWb2x1.png)

### [Auto Switch Input](https://apps.apple.com/au/app/autoswitchinput/id1470350547?mt=12)

- 推荐指数：★★★★★
- 费用：免费
- 推荐理由：切换软件时自动改正输入法，比如敲代码时去微信回消息，用这个软件超级方便！

<img src='https://i.loli.net/2021/02/21/vVkhfQ9ZAOlBJyn.png' alt='vVkhfQ9ZAOlBJyn'/>

### [uPic](https://github.com/gee1k/uPic)

- 推荐指数：★★★★☆
- 费用：免费
- 推荐理由：只需要把本地图片拖拽到menu bar上，就可以长传到云端。对于用markdown写文档到人非常赞！如果搭配typora则会事半功倍，因为typora可以配合uPic自动长传。

<img src='https://i.loli.net/2021/02/21/3HXBw7ags9dFbJl.gif' alt='3HXBw7ags9dFbJl'/>

### [Keka](https://www.keka.io/en/)

- 推荐指数：★★★★☆
- 费用：免费
- 推荐理由：虽然苹果有自带压缩或解压的软件，但只能解压一下大众的压缩包格式，碰到了`rar`的压缩包，还得用terminal，非常麻烦。这个软件可以一键打开任何文件，十分方便。

<img src='https://i.loli.net/2021/02/21/bIEYM3rvfOGUgx4.gif' alt='bIEYM3rvfOGUgx4'/>
...
- 推荐指数：★★★☆☆
- 费用：免费
- 推荐理由：免费看各种电视剧，视频，无广告。但是软件只提供下载链接，不提供下载功能。

<img src='https://i.loli.net/2021/02/21/9QOJbsYL2TyElMf.gif' alt='9QOJbsYL2TyElMf'/>
...
- 推荐指数：★★★★☆
- 费用：免费
- 推荐理由：一款`NTFS`格式读写工具，软件虽小但是功能强大。

<img src='https://i.loli.net/2021/02/21/XZQawER9jd7Ncys.png' alt='XZQawER9jd7Ncys'/>
